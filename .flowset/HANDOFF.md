...
## Active WI
(없음) — WI-004-fix **develop 머지 대기**(검증 PASS, commit `bc334a7`, PR 생성 예정). 다음 우선은 **WI-005-fix(소켓 ban/kick 실시간, P2)** → WI-006/010/011/012(P3 부채).
